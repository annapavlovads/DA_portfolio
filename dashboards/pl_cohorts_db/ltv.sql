...
--Анализируется сумма чека, совершенного пользователями в различные временные интервалы после первой покупки.

--Использование:
--Этот запрос помогает оценить поведение пользователей в различные дни, недели, месяцы и годы после их первой покупки: 
--изменение активности и среднего чека у пользователей в течение определенных временных интервалов.
