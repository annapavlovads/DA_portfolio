...
--Входные данные:
--1. Таблица dwh.contacts_info, содержащая информацию о контактах, включая их идентификаторы и даты первого взаимодействия с продуктом.
...
--Полученные данные позволят оценить среднюю активность пользователей в различные периоды времени после начала их использования продукта или услуги.
