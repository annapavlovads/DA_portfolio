...
-- покупки и определение их ценности в различные периоды. Результаты запроса позволяют оценить, как меняется LTV клиентов 
-- в различные интервалы времени после первой покупки, что может быть полезно при принятии решений о стимулировании продаж 
...
-- Размер когорты, контактов
-- Макс. кол-во дней для LTV 
...
-- 2. Подзапросы выполняют необходимые операции по фильтрации, группировке и условным расчетам для LTV в различные периоды времени
  
-- Результатом выполнения запроса является таблица с показателями LTV для различных временных интервалов для каждой когорты. 
--Это позволяет оценить динамику LTV во времени.
-----------------------------------------------------------------------------------------
