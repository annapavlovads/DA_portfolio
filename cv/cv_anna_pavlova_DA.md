...
- ноябрь 2022 г. - настоящее время: аналитик данных управляющей компании ресторанного бизнеса (продуктовая - сайт и мобильное приложение, маркетинговая, CRM-аналитика, аналитика для отдела продаж - 30 ресторанов в 5 регионах РФ)
