...
- Использую BI-системы (Superset, Yandex DataLens, Redash) для построения визуализаций данных вплоть до многоуровневых дашбордов 
- Проектирую и реализую дашборды с использованием методики Dashboard Canvas и проведением интервью с заказчиком аналитики, составляю документацию для дашбордов и обучаю их использованию в целях развития self-service аналитики для менеджеров компании
